...
class JVisualContentViewExtraField extends JViewLegacy{
    ...
    protected function addToolbar(){
        ...
        JToolBarHelper::title(JText::sprintf('COM_JVISUALCONTENT_EXTRAFIELD_MANAGER_TASK',
            JText::_(($isNew)?'COM_JVISUALCONTENT_PAGE_ADD_EXTRAFIELD':'COM_JVISUALCONTENT_PAGE_EDIT_EXTRAFIELD')));
